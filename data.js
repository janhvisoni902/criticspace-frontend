/**
 * CriticspaceAgency - Dynamic Content Configuration
 * Stored as a global object to allow instant customization without CORS module restrictions.
 */

window.Criticspace_DATA = {
    brandName: "Criticspace Vision",
    tagline: "Strategic Video Growth Engine",
    contactEmail: "Criticspacevision@gmail.com",
    ...
    featuredNews: [
        ...
        },
        {
            ...
            date: "May 2026",
            blurb: "A study highlighting Criticspace Vision's structured 90-day growth framework for converting views into direct inbound call bookings without any paid ads spend.",
            link: "#"
        }
    ],
    ...
    testimonialVideos: [
        {
            ...
            quote: "Criticspaceturned our cold views into warm pipeline. Best growth system we ever used.",
        ...
        },
        {
            ...
            quote: "Quality can't be mass-produced, but Criticspacegets incredibly close. Masterclass delivery.",
            videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-young-man-wearing-headphones-listens-to-music-40508-large.mp4",
    ...
    faqs: [
        {
            num: 1,
            q: "What exactly does Criticspacedo?",
        ...
        {
            num: 2,
            q: "How is Criticspacedifferent from freelancers or agencies?",
        ...
        },
        {
            ...
            a: "A full-time senior editor costs $100K+/year; Criticspacedelivers a full growth system (strategy, retention editing, SEO, distribution) for a fraction of the cost with no long-term commitment."
        },
        {
            num: 6,
        ...
        {
            num: 9,
            q: "Where is Criticspacebased? Do you work worldwide?",
